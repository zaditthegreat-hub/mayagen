...
// Dibuat: 2025-12-18
// Deskripsi: Form persona dengan PlaygroundBannerV2 (text chatbot widget)
...
// DUPLIKAT-V2: Import banner versi chatbot
import PlaygroundBannerV2 from './playground-banner-v2';
...
// DUPLIKAT-V2: Component name changed
export default function CreateEditPersonaV2({ id }: { id?: string }) {
            ...
            <div className="grid grid-cols-1 gap-6 xl:grid-cols-12">
                ...
                <div className="xl:col-span-5 2xl:col-span-4">
                    <div className="sticky top-24">
                        {/* DUPLIKAT-V2: Menggunakan PlaygroundBannerV2 */}
                        <PlaygroundBannerV2 className="h-[400px] xl:h-auto" />
